  ...
  public: {
    Tables: {
      ...
      citizen_neighborhoods: {
        ...
        Relationships: [
          {
            foreignKeyName: "citizen_neighborhoods_citizen_phone_fkey";
          ...
          {
            foreignKeyName: "citizen_neighborhoods_neighborhood_id_fkey";
      ...
      neighborhoods: {
        Row: {
          ...
          latitude: number | null;
          longitude: number | null;
          mukhtar_name: string | null;
          mukhtar_phone: string | null;
          name: string;
    ...
    Functions: {
      can_access_department: { Args: { _dept: string }; Returns: boolean };
      current_user_department: { Args: never; Returns: string };
      current_user_deputy: { Args: never; Returns: string };
      has_role: {
        Args: {
      ...
      user_has_module: { Args: { _module: string }; Returns: boolean };
    };
    Enums: {
      app_role:
        | "vatandas"
