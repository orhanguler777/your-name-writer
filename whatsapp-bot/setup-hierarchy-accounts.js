...
async function upsertProfile(
  userId,
  { email, fullName, departmentId = null, deputyMayorId = null },
) {
...
async function setRoles(userId, roles) {
  ...
  console.log(
    `   roller: [${roles.join(", ")}]${extra.length ? `  (kaldırıldı: ${extra.join(", ")})` : ""}`,
  );
}
