...
doc.fontSize(14).fillColor(secondaryColor).text("RUHSAT VE DENETİM MÜDÜRLÜĞÜ", { align: "center" });
...
doc
  .fillColor(primaryColor)
  .fontSize(10)
  .text("ALANYA BELEDİYESİ RUHSAT VE DENETİM MÜDÜRLÜĞÜ", 60, 660, {
    font: fontRegistered ? "Arial" : "Helvetica-Bold",
  })
  .fillColor(secondaryColor)
  .fontSize(9)
  .text(
    "Adres: Saray Mahallesi, Atatürk Caddesi No:6 (Belediye Merkez Binası) Alanya/Antalya",
    60,
    675,
  )
