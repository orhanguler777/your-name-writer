...
if (!fontRegistered) {
  console.log(
    "⚠️ Arial fontu bulunamadı, varsayılan font kullanılacak. Türkçe karakterler bazı PDF okuyucularda hatalı görünebilir.",
  );
  doc.font("Helvetica");
}
...
doc.fontSize(14).fillColor(secondaryColor).text("EVLENDİRME MEMURLUĞU", { align: "center" });
...
doc.rect(50, 650, 495, 80).fillAndStroke(lightBgColor, primaryColor);

doc
  .fillColor(primaryColor)
  .fontSize(10)
  .text("ALANYA BELEDİYESİ NİKAH DAİRESİ", 60, 660, {
    font: fontRegistered ? "Arial" : "Helvetica-Bold",
  })
