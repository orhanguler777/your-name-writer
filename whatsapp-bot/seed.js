...
const departments = [
  { name: "Fen İşleri Müdürlüğü", description: "Yol, kaldırım, asfalt ve altyapı işleri" },
  {
    ...
    description: "Çöp toplama, sokak temizliği ve atık yönetimi",
  },
  {
    name: "Park ve Bahçeler Müdürlüğü",
    description: "Parklar, yeşil alanlar, ağaç budama ve peyzaj",
  },
  { name: "Ruhsat ve Denetim Müdürlüğü", description: "İşyeri açma ve çalışma ruhsatları" },
  {
    name: "İmar ve Şehircilik Müdürlüğü",
    description: "İmar planları, kaçak yapı denetimi ve inşaat izinleri",
  },
  {
    name: "Su ve Kanalizasyon Müdürlüğü",
    description: "Su şebekesi, kanalizasyon, su patlakları ve altyapı",
  },
  {
    name: "Ulaşım Hizmetleri Müdürlüğü",
    description: "Toplu taşıma, duraklar ve trafik düzenlemeleri",
  },
  {
    name: "Veteriner İşleri Müdürlüğü",
    description: "Sokak hayvanları rehabilitasyon ve bakım hizmetleri",
  },
  ...
  { name: "Zabıta Müdürlüğü", description: "Denetim, gürültü kontrolü ve çevre düzeni" },
  {
    ...
    description: "Sosyal yardımlar ve kültürel etkinlikler",
  },
];
